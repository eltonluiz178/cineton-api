...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendConfirmationEmail(String email, String name, String code, String expiresAt) {
        try {
            ...
            String dataExpiracaoFormatada = formatarDataExpiracao(expiresAt);

            String htmlContent = getHtmlTemplate(name, code, dataExpiracaoFormatada);
    ...
    private String formatarDataExpiracao(String expiresAtAsText) {
        try {
            OffsetDateTime expira = OffsetDateTime.parse(expiresAtAsText);

            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy 'às' HH:mm");

            return expira.format(formatter);
        } catch (Exception e) {
            return expiresAtAsText;
        }
    }
